...
namespace RegistrationandLogin.Controllers
{
    ...
    public ActionResult Registration()
       ...
       [AllowAnonymous]
        ...
        [HttpGet]
        public ActionResult ManPowerRegister()
        {
        ...
        public ActionResult ManPowerRegister(StaffRegistrationVM user)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                using (DataBaseContext db = new DataBaseContext())
                {
                    ...
                    u.NID = user.NID;
                    u.DrivingLicense = user.DrivingLicense;
            ...
            ViewBag.UserTypeID = new SelectList(db1.userTypes, "ID", "Name", user.UserTypeID);
            return View(user);
